...
| <a name="input_experimental"></a> [experimental](#input\_experimental) | Experimental Slurm settings. Enable at your own risk. | <pre>object({<br/>    enable_async_reply = optional(bool, false)<br/>  })</pre> | `{}` | no |
